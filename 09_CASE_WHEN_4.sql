...
결과에 세 가지 카테고리가 모두 포함되어야 합니다. 카테고리에 계좌(account_id)가 없으면 0을 보고합니다.
소득 카테고리는 다음과 같습니다.
'Low Salary': 소득(income)가 $20,000 미만입니다.
'Average Salary': 소득(income)가 [20,000, 50,000] 사이입니다.
'High Salary': 소득(income)이 $50,000보다 큽니다.
*/
