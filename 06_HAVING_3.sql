/*
[질문]
활성 비즈니스는 해당 이벤트 유형(event_type)의 평균 발생 횟수(occurences)보다 더 많이 발생하는 이벤트 유형(event_type)이 두 개 이상 있는 비즈니스입니다.
...
WHERE e.occurences > avge.avg_occ; /* 해당 이벤트 유형의 평균 발생 횟수보다 큰 경우 */
...
ON e.event_type = avge.event_type
WHERE e.occurences > avge.avg_occ /* 해당 이벤트 유형의 평균 발생보다 큰 경우 */
