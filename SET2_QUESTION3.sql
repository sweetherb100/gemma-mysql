/*
[질문]
가장 많은 영화를 평가한 사용자의 이름을 조회하는 SQL 쿼리를 작성합니다. 동점인 경우 사전순으로 더 앞에 있는 사용자 이름을 반환합니다.
2025년 2월 평균 평점이 가장 높은 영화명을 조회하는 SQL 쿼리를 작성합니다. 동점인 경우 사전순으로 더 앞에 있는 영화 이름을 반환합니다.
*/
